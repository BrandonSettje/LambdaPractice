...
namespace LambdaPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (string Kproduct in kayakProducts)
            {
                Console.WriteLine(Kproduct);
            }
            ...
            foreach (string RProducts in reversedProducts)
            {
                Console.WriteLine(RProducts);
            }
            ...
            foreach (string Lproducts in products.OrderByDescending(x => x.Length).ToList())
            {
                Console.WriteLine(Lproducts);
            }
